...
export default function PreviewTableRpm({ 
    previewData = [], 
    ...
    const getItemId = useCallback((item) => item.rpm_id || item.site_id, []);
            ...
            <div className="p-5 border-b border-slate-200 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-950/60 flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-slate-900 dark:text-white">
                            Pratinjau Data RPM Terdeteksi ({previewData.length.toLocaleString('id-ID')} Data #N/A)
                        </h3>
                ...
                <div className="flex items-center gap-2.5">
                    ...
                    >
                        ...
                        <span>{isSavingMaster ? 'Menyimpan...' : 'Masukkan ke Master Data RPM'}</span>
                    </Button>
                </div>
            </div>
